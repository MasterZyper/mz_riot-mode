...
client_script 'mz_riot_mode.net.dll';

--Config:
--	0 = Dekaktiviert 
--	1 = Aktiviert

--riot_mode -> Löst den PanikModus in der Stadt aus, Warnung! Alles kann und wird Eskalieren!
riot_mode '1'
--random_plane_fights -> Erstellt zufällig Luftkämpfe
random_plane_fights '1'